...
--I will try to add all the best level routes for the Chamipions. If you feel a Champion has a better build order, feel free to edit it, or, get ahold of me,and I would confirm it and add it. If you would like to not use auto level for a specific Champion, comment out his/her name. "-- elseif"
